# Generated by Powerlevel10k configuration wizard on 2021-02-17 at 19:27 +0330.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_GAP_BACKGROUND=1
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{LEFT,RIGHT}_RIGHT_WHITESPACE=' '
